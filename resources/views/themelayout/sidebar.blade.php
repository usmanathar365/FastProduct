                                ...
                                <ul class="sa-nav__menu sa-nav__menu--root">
                                    ...
                                    <li class="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open">
                                        ...
                                        <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                            ...
                                            <li class="sa-nav__menu-item">
                                                <a href="{{route('add.product')}}" class="sa-nav__link">
                                                    <span class="sa-nav__menu-item-padding"></span>
                                            ...
                                            <li class="sa-nav__menu-item">
                                                <a href="{{route('add.category')}}" class="sa-nav__link">
                                                    <span class="sa-nav__menu-item-padding"></span>
                                                    <span class="sa-nav__title">Category</span>
                                                </a>
                                            </li>
                                            <li class="sa-nav__menu-item">
                                                <a href="{{route('brand')}}" class="sa-nav__link">
                                                    <span class="sa-nav__menu-item-padding"></span>
                                                    <span class="sa-nav__title">Brands List</span>
                                                </a>
                                            </li>
                                            <li class="sa-nav__menu-item">
                                                <a href="{{route('add.brand')}}" class="sa-nav__link">
                                                    <span class="sa-nav__menu-item-padding"></span>
